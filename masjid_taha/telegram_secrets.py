# ⚠️ ملف أسرار محلي - لا تشاركه ولا ترفعه على git (مستثنى بالفعل عبر .gitignore)
#
# TELEGRAM_BOT_TOKEN: التوكن الخاص ببوت التلغرام (من BotFather)
# TELEGRAM_CHAT_ID: هوية المحادثة/المجموعة التي سيُرسل إليها البوت الرسائل
#
